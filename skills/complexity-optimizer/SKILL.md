...
python3 scripts/analyze_complexity.py /tmp/base --write-baseline /tmp/base.json
python3 scripts/analyze_complexity.py . --changed main --baseline /tmp/base.json   # findings tagged NEW
