...
1. Establish the baseline:
   ...
   - Run `~/.claude/commands/complexity-optimizer/analyze_complexity.py <repo>` for a first-pass hotspot list when scanning a repository.
...
python3 ~/.claude/commands/complexity-optimizer/analyze_complexity.py /path/to/repo --format json
```
